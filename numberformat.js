!function(i,n)
{
"object"==typeof exports&&"object"==typeof module?module.exports=n(require("decimal.js")):"function"==typeof define&&define.amd?define(["decimal.js"],n):"object"==typeof exports?exports.numberformat=n(require("decimal.js")):i.numberformat=n(i["decimal.js"])
}
(this,function(i)
{
return function(i)
...
function n(l)
{
if(t[l])return t[l].exports;var o=t[l]=
{
exports:
{
...
;return i[l].call(o.exports,o,o.exports,n),o.loaded=!0,o.exports
}
var t=
{

}
;return n.m=i,n.c=t,n.p="",n(0)
}
([function(i,n,t)
{
(function(i)
{
"use strict";function l(i)
{
...
function r(i,n)
{
if(!i)throw new Error(n);return i
}
function e(i,n)
{
var t=r(v[n.backend],"not a backend: "+n.backend);i=t.normalize(i,n);var l=t.index(i),o=n.suffixFn(l);if(Math.abs(i)<n.minSuffix)return Math.abs(i)>=n.minRound&&(i=Math.floor(i)),i.toLocaleString(void 0,
{
maximumSignificantDigits:n.sigfigs
}
);if(!o&&""!==o)return i.toExponential(n.sigfigs-1).replace("e+","e");var e=t.prefix(i,l,n);return""+e+o
}
Object.defineProperty(n,"__esModule",
{
value:!0
}
),n.formatShort=n.formatFull=n.format=n.Formatter=n.Formats=void 0;var a=Object.assign||function(i)
{
for(var n=1;n<arguments.length;n++)
{
var t=arguments[n];for(var l in t)Object.prototype.hasOwnProperty.call(t,l)&&(i[l]=t[l])
}
return i
}
,u=function()
...
{
var l=n[t];l.enumerable=l.enumerable||!1,l.configurable=!0,"value"in l&&(l.writable=!0),Object.defineProperty(i,l.key,l)
}

}
return function(n,t,l)
{
return t&&i(n.prototype,t),l&&i(n,l),n
}

}
(),d=t(1),s=l(d),g=t(2),f=l(g),c=function()
{
return Math.log10?Math.log10:function(i)
{
var n=Math.log(i)/Math.LN10;return n=Math.round(1e6*n)/1e6
}
...
,index:function(i)
{
return Math.max(0,Math.floor(c(Math.abs(i))/3))
}
,prefix:function(i,n,t)
{
var l=t.sigfigs;return(i/Math.pow(1e3,n)).toPrecision(l)
}

}
,"decimal.js":
{
_requireDecimal:function(n)
{
var l=void 0;return l=i.window&&window.Decimal?window.Decimal:t(3),l.clone(n)
}
,normalize:function(i,n)
{
var t=n.rounding,l=this._requireDecimal(
{
rounding:t
}
);return new l(i)
...
,index:function(i)
{
var n=this._requireDecimal();return i=new n(i),Math.floor(i.e/3)
}
,prefix:function(i,n,t)
{
var l=t.sigfigs,o=t.rounding,r=this._requireDecimal(
{
rounding:o
}
),e=new r(1e3).pow(n);return new r(i).dividedBy(e).toPrecision(l)
}
...
,p=
{
backend:"native",flavor:"full",suffixGroup:"full",suffixFn:function(i)
{
var n=this.suffixes||this.suffixGroups[this.suffixGroup];if(r(n,"no such suffixgroup: "+this.suffixGroup),i<n.length)return n[i]||""
}
,minSuffix:1e5,minRound:0,sigfigs:3,format:"standard"
}
,q=n.Formats=
{
standard:
{
suffixGroups:s.default
}
,longScale:
{
suffixGroups:f.default
}
,scientific:
{
suffixGroups:
...
suffixGroups:
{
full:s.default.full.slice(0,12),short:s.default.short.slice(0,12)
}
...
full:
{
suffixGroup:"full",sigfigs:5
}
,short:
{
suffixGroup:"short",sigfigs:3
}

}
;p.formats=q,p.flavors=m;var x=n.Formatter=function()
{
function i()
{
...
;o(this,i),this.opts=t;for(var l=Object.keys(this._normalizeOpts().flavors),r=0;r<l.length;r++)!function(i)
{
var t=l[i],o="format"+t.charAt(0).toUpperCase()+t.substr(1);n[o]=function(i,l)
{
return n.formatFlavor(i,t,l)
}
...
return u(i,[
{
key:"_normalizeOpts",value:function()
{
...
,this.opts,i);var n=i&&i.format,t=i&&i.formats||p.formats,l=t[n||p.format];r(l,"no such format: "+n);var o=i&&i.flavor,e=i&&i.flavors||p.flavors,u=e[o||p.flavor];return r(u,"no such flavor: "+o),a(
{
...
,
{
key:"index",value:function(i,n)
{
return n=this._normalizeOpts(n),v[n.backend].index(i)
}

}
,
{
key:"suffix",value:function(i,n)
{
n=this._normalizeOpts(n);var t=v[n.backend].index(i);return n.suffixFn(t)
}

}
,
{
key:"format",value:function(i,n)
{
...
,
{
key:"formatFlavor",value:function(i,n,t)
{
return this.format(i,a(
{
...
,
{
key:"listFormats",value:function(i)
{
...
(),D=new x;D.defaultOptions=p,D.Formatter=x,n.default=D;n.format=function(i,n)
{
return D.format(i,n)
}
,n.formatFull=function(i,n)
{
return D.formatFlavor(i,"full",n)
}
,n.formatShort=function(i,n)
{
return D.formatFlavor(i,"short",n)
}
